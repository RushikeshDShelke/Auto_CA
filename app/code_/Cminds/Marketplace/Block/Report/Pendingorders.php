...
class Pendingorders extends Template
{
    ...
    public function getPendingOrdersCollection() 
    {
        ...
        $collection->addAttributeToFilter('main_table.status', array('in' => array("pending","pending")));
