...
{
    /**
     * @var \Dotzotfront\Base\Model\Product
     */
    protected $baseProduct;

    /**
     * @var \Dotzotfront\Base\Helper\Main
     */
    protected $main;
    ...
    public function __construct(
        ...
        \Dotzotfront\Base\Helper\Main $main,
    ...
    protected function _renderValue(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        if ($product->getSession()) {
            if ($product->isInStock()) {
                ...
                $html .= '<div class="tooltip"><span><span><img src="'.$this->getViewFileUrl('Dotzotfront_Base::images/success_msg_icon.gif').'" style="margin-top: 2px;float: right;" /></span></span>';
                $html .= '<div class="tooltip-content">' . $title . '</div></div>';
            } else {
                $html .= '<div class="tooltip"><span><span><img src="'.$this->getViewFileUrl('Dotzotfront_Base::images/error_msg_icon.gif').'" style="margin-top: 2px;float: right;" /></span></span></div>';
            }
        }
    ...
    public function render(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        foreach ($fields as $key => $value) {
            $comment = ($key == 'plumbase_account_email') ? '<p class="note">
                <span>' . __('You can find Marketplace Order ID and Email in your Magento Marketplace Account. For manual <a target="_blank" href="%1">click here</a>.', 'http://wiki.Dotzotfront.com/License_Installation_For_Magento_2_Marketplace_Customers')
                . '</span></p>' : '';
    ...
    {
        return $this->objectManager->get('Dotzotfront\\' . $name . '\Helper\Main');
    }
}