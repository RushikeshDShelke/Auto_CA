                    ...
                    if ($isCodeLengthValid && $coupon->getId()) {
                        ...
                        if ($isCodeLengthValid && $coupon->getId() && $couponCode == $cartQuote->getCouponCode()) {
                                ...
                                if($couponCode == 'PP640')
                                {
                                         $this->messageManager->addSuccessMessage(
                                        __(
                                                'Congratulations!!  Your order qualifies for a free beautifully hand crafted Marble Table Clock worth INR 640. This will be shipped along with your order.
Shipping is free for your order!',
                        ...
                        if($couponCode == 'PP640')
                        {
                                $msg = 'This coupon is valid for cart value above INR 2,000. Increase your purchase value and get a beautifully hand crafted Marble Table Clock worth INR 640.';
                                 $this->messageManager->addErrorMessage(
                                __('%1', $msg)
                            );
                        }else{
