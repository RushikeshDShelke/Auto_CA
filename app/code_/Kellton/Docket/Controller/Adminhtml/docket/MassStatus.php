...
class MassStatus extends \Magento\Backend\App\Action
{
    ...
    {
        $itemIds = $this->getRequest()->getParam('docket');
        if (!is_array($itemIds) || empty($itemIds)) {
            ...
            try {
                ...
                foreach ($itemIds as $postId) {
                    $post = $this->_objectManager->get('Kellton\Docket\Model\Docket')->load($postId);
        ...
        return $this->resultRedirectFactory->create()->setPath('docket/*/index');
    }
