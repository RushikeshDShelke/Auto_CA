...
class MassStatus extends \Magento\Backend\App\Action
{
    ...
    {
        $itemIds = $this->getRequest()->getParam('shipmentdelay');
        if (!is_array($itemIds) || empty($itemIds)) {
            ...
            try {
                ...
                foreach ($itemIds as $postId) {
                    $post = $this->_objectManager->get('Kellton\Shipmentdelay\Model\Shipmentdelay')->load($postId);
        ...
        return $this->resultRedirectFactory->create()->setPath('shipmentdelay/*/index');
    }
