...
{
    /**
     * @var \Dotzotfront\Base\Helper\Base
     */
    ...
    /**
     * @param \Dotzotfront\Base\Helper\Base                         $baseHelper
    ...
    public function __construct(
        \Dotzotfront\Base\Helper\Base $baseHelper,
    ...
    public function getModuleInfoHtml()
    {
        ...
        $html = '<tr><td class="label" colspan="4" style="text-align: left;"><div style="padding:10px;background-color:#f8f8f8;border:1px solid #ddd;margin-bottom:7px;">
            ' . $this->_moduleName . ' v' . $m['setup_version'] . ' was developed by <a href="https://store.Dotzotfront.com" target="_blank">Dotzotfront Inc</a>.
