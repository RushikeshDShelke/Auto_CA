...
namespace Kellton\Newsletter\Controller\Plugin\Subscriber;
        ...
        if ($this->getRequest()->isPost() && $this->getRequest()->getPost('email')) {
            ...
            try {
                ...
                $response = [
				  ...
				  CURLOPT_URL => "https://hooks.zapier.com/hooks/catch/1903329/ozd51qf/",
				  ...
				  CURLOPT_POSTFIELDS => array('Email' => $email,'Date' => $date),
				));
