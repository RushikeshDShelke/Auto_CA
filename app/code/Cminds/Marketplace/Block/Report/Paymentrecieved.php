...
class Paymentrecieved extends Template
{
    ...
    public function getPaymentReceivedCollection() 
    {
        ...
        $collection->addAttributeToFilter('main_table.status', array('in' => array("processing","complete")));
