...
if($_REQUEST)
{
	...
	$sql = "Update ".$po_order_data." Set status = 'requested_for_approval',email_sent=0,payment_term='".$payment_term."',freight_term='".$freight_term."',created_at='".date("Y-m-d h:i:s")."',created_by='".$_SESSION['username']."' where id = '".str_replace($po_no, '', $_REQUEST['po_no'])."'";
