...
//echo $customer->getLastname(); //Print Customer Last Name
        ...
        <h2>Products of <?php echo $customer->getFirstname()." ".$customer->getLastname() ?></h2>
        ...
        <table align='center'><tr><th>SKU</th><th>Name</th><th>Qunatity</th><th>MC Price</th><th>MC Total</th></tr>
<?php
        $dateCounter = 0;
...
?>
	...
	<td><?php $objectManager = \Magento\Framework\App\ObjectManager::getInstance();
$StockState = $objectManager->get('\Magento\InventorySalesAdminUi\Model\GetSalableQuantityDataBySku');
$qty = $StockState->execute($productObj->getSku());
echo($qty[0]['qty']);?></td>
	<td><?php echo $productObj->getMarketplaceFee() ?></td>
	<td><?php echo ((float)$productObj->getMarketplaceFee() * $qty[0]['qty'])?></td>
        </tr>
<?php
                $dateCounter++;
        }
