...
if(isset($_SESSION['id']) && !empty($_SESSION['id']) && isset($_SESSION['username']) && !empty($_SESSION['username']) && isset($_SESSION['role']) && !empty($_SESSION['role']))
{
        ...
        echo "<div class='logout'><a href='".$baseUrl."wms_inventory_inwards.php'>Inward form || </a><a href='".$baseUrl."wms/wms_inventory_report.php'>Inventory Report || </a>";
        if($_SESSION['role'] == 'admin' || $_SESSION['role'] == 'ALL-WH'){echo "<a href='".$baseUrl."wms_PO_inwards.php'>PO Generation || </a>"; }
        echo "<a href='".$baseUrl."wms/wms_PO_listing.php'>Purchase Orders || </a><a href='".$baseUrl."wms/product_planning_report.php'>Product Planning Report || </a><a href='".$baseUrl."wms/sku_inventory_history.php'>SKU Inventory History || </a><a href='".$baseUrl."wms_logout.php'>Logout</a></div>";
...
$collection = $productCollection->create()
        ...
        //->addAttributeToSelect('name')
            ->load();
?>
<form name="searchsku" action="wms/wms_sku_history_result.php" method="post">
